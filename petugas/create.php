...
$result = mysqli_query($connection, "SELECT MAX(id) id FROM petugas");
if (!$result) { 
        ...
        <div class="card-body">
          ...
          <form action="./store.php" method="POST">
            <table cellpadding="8" class="w-100">
              ...
              <tr>
                <td>ID</td>
                <td><input class="form-control" readonly value="<?= $lastid ?>" type="number" name="nidn" size="20" required></td>
              </tr>
              <tr>
                <td>username</td>

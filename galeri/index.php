...
$result = mysqli_query($connection, "SELECT galery.id, galery.post_id, post.judul, galery.position, galery.status FROM galery JOIN post ON post.id = galery.post_id;")
?>
